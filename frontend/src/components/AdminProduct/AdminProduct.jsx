...
const AdminProduct = () => {
    ...
    const typeProduct = useQuery({queryKey: ['type-product', currentPage, pageSize],queryFn: fetchAllTypeProduct })
            ...
            <ModalComponent title="Tạo sản phẩm" open={isModalOpen} onCancel={handleCancel} footer={null}>
                ...
                >
                    ...
                    <Form.Item
                        label="Loại sản phẩm"
                        name="type"
                        rules={[{ required: true, message: 'Vui lòng chọn hoặc nhập loại sản phẩm!' }]}
                    >
                        <Select
                            ...
                            onChange={(value) => {
                                setStateProduct({
                                    ...stateProduct,
                                    type: value,
                                    newType: value !== 'add_type' ? '' : stateProduct.newType 
                                })
                                setTypeSelect(value)
                            }}
                            dropdownRender={(menu) => (
                                <>
                                    ...
                                    <div style={{ padding: '8px', borderTop: '1px solid #f0f0f0' }}>
                                        <Input
                                            ...
                                            onChange={(e) => setStateProduct({ ...stateProduct, newType: e.target.value })}
                    ...
                    {stateProduct.type === 'add_type' && (
                        <Form.Item
                            label="Tên loại mới"
                            name="newType"
                            rules={[{ required: true, message: 'Vui lòng nhập tên loại mới!' }]}
                        >
                            <InputComponent
                ...
                <Loading isLoading={isLoadingUpdate || isLoadingUpdate}>
                    ...
                    >
                        ...
                        <Form.Item
                            label="Discount"
                            name="discount"
                            rules={[{ required: true, message: 'Please input your discount or product!' }]}
                        >
